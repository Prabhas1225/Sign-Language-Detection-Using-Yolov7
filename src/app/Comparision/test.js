...
function ImageUploader({ onUpload }) {
  ...
  return (
    ...
    role="status"></div><div className="pt-2 grow "><span className="-pl-3 mb-20 font-semibold">Preparing Output </span></div></div>
...
<div >
  { output &&<div className="ml-[150px] mt-[45px] pl-11 pt-4 bg-[#7366C0] w-56 h-16 rounded-xl content-center items-center font-medium "><a href={"/exp/"+ output} download>
    Download Ouptput
      </a></div>}
</div>   
</div>
